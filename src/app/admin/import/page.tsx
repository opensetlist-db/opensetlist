...
const IMPORT_TYPES = [
  ...
  },
  {
    value: "events",
    label: "5. 이벤트 (Events)",
    columns: ["series_slug", "series_ja_name", "series_ja_shortName", "series_ko_name", "series_ko_shortName", "series_type", "event_slug*", "parentEvent_slug", "event_type", "date", "startTime", "country", "ja_name", "ja_shortName", "ja_city", "ja_venue", "ko_name", "ko_shortName", "ko_city", "ko_venue", "artist_slug", "event_performer_slugs", "event_guest_slugs"],
